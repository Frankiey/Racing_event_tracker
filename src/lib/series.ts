...
export const SERIES: Record<string, SeriesMeta> = {
  ...
  f3:      { id: 'f3',      label: 'Formula 3',   shortLabel: 'F3',       color: '#0090d0', textClass: 'text-blue-300',    bgClass: 'bg-blue-300',    order: 3 },
  ...
  indycar: { id: 'indycar', label: 'IndyCar',     shortLabel: 'IndyCar',  color: '#1e40af', textClass: 'text-blue-700',    bgClass: 'bg-blue-700',    order: 6 },
  nascar:  { id: 'nascar',  label: 'NASCAR',      shortLabel: 'NASCAR',   color: '#eab308', textClass: 'text-yellow-500',  bgClass: 'bg-yellow-500',  order: 7 },
  wec:     { id: 'wec',     label: 'WEC',         shortLabel: 'WEC',      color: '#0ea5e9', textClass: 'text-sky-400',     bgClass: 'bg-sky-400',     order: 8 },
};
