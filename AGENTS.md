...
> **This file is the single source of truth for agent instructions.** Harness-specific files (`CLAUDE.md`, `.github/copilot-instructions.md`) only point here — edit this file, never those.
