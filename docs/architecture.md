...
### Path B — Seed series (F2, F3, Formula E, IndyCar, WEC, IMSA, DTM, GT World Challenge Europe, NLS, Super Formula, IOMTT)
...
- Current seed series: `f2`, `f3`, `fe`, `indycar`, `wec`, `imsa`, `dtm`, `gtworld`, `nls`, `superformula`, `iomtt`
...
| Moto2 | `pipeline/fetchers/moto_support.py` | Pulselive support-category sessions | API | [moto2-moto3.md](./data-sources/moto2-moto3.md) |
| Moto3 | `pipeline/fetchers/moto_support.py` | Pulselive support-category sessions | API | [moto2-moto3.md](./data-sources/moto2-moto3.md) |
